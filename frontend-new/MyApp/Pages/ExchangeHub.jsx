  ...
  const getFilteredData = () => {
    ...
    if (activeSubTab === 'lend') {
      return requestsData
        ...
        .map(request => ({
          ...request,
          user_name: profiles.find(p => p.uuid === request.user_id)?.name || 'Unknown'
        }));
    } else {
      return offersData
        ...
        .map(offer => ({
          ...offer,
          user_name: profiles.find(p => p.uuid === offer.user_id)?.name || 'Unknown'
        }));
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.subTabContainer}>
        <TouchableOpacity 
          style={[styles.subTabButton, activeSubTab === 'lend' && styles.activeSubTab]}
          onPress={() => setActiveSubTab('lend')}
        >
          <Text style={styles.subTabText}>Lend</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.subTabButton, activeSubTab === 'request' && styles.activeSubTab]}
          onPress={() => setActiveSubTab('request')}
        >
          <Text style={styles.subTabText}>Request</Text>
        </TouchableOpacity>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyText}>
            No {activeSubTab === 'lend' ? 'requests' : 'offers'} found for {activeTab}
          </Text>
        }
      />
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.radioGroup}>
                  <TouchableOpacity 
                    style={[
                      styles.radioButton, 
                      formData.request_type === 'product' && styles.radioButtonActive
                    ]}
                    onPress={() => setFormData({
                      ...formData, 
                      request_type: 'product'
                  ...
                  <TouchableOpacity 
                    style={[
                      styles.radioButton, 
                      formData.request_type === 'service' && styles.radioButtonActive
                    ]}
                    onPress={() => setFormData({
                      ...formData, 
                      request_type: 'service'
                ...
                <>
                  <View style={styles.formRow}>
                    <View style={[styles.formGroup, { flex: 1 }]}>
                      ...
                      <TouchableOpacity 
                        onPress={() => {
                          setTempDate(formData.from_date ? new Date(formData.from_date) : new Date());
                      ...
                      {formErrors.from_date && (
                        <Text style={styles.errorText}>{formErrors.from_date}</Text>
                      )}
                    </View>
                    <View style={[styles.formGroup, { flex: 1 }]}>
                      ...
                      <TouchableOpacity 
                        onPress={() => {
                          setTempDate(formData.to_date ? new Date(formData.to_date) : new Date());
                      ...
                      {formErrors.to_date && (
                        <Text style={styles.errorText}>{formErrors.to_date}</Text>
                      )}
                    </View>
                  </View>
                  ...
                  <View style={styles.formRow}>
                    <View style={[styles.formGroup, { flex: 1 }]}>
                      ...
                      <TouchableOpacity 
                        onPress={() => {
                          setTempDate(formData.from_time ? new Date(`1970-01-01T${formData.from_time}:00`) : new Date());
                      ...
                      {formErrors.from_time && (
                        <Text style={styles.errorText}>{formErrors.from_time}</Text>
                      )}
                    </View>
                    <View style={[styles.formGroup, { flex: 1 }]}>
                      ...
                      <TouchableOpacity 
                        onPress={() => {
                          setTempDate(formData.to_time ? new Date(`1970-01-01T${formData.to_time}:00`) : new Date());
                      ...
                      {formErrors.to_time && (
                        <Text style={styles.errorText}>{formErrors.to_time}</Text>
                      )}
                    </View>
                  </View>
                </>
